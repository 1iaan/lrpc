...
extern queryOrderRequestDefaultTypeInternal _queryOrderRequest_default_instance_;
class queryOrderResponse;
struct queryOrderResponseDefaultTypeInternal;
extern queryOrderResponseDefaultTypeInternal _queryOrderResponse_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::queryOrderRequest* Arena::CreateMaybeMessage<::queryOrderRequest>(Arena*);
template<> ::queryOrderResponse* Arena::CreateMaybeMessage<::queryOrderResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class queryOrderRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:queryOrderRequest) */ {
 public:
  inline queryOrderRequest() : queryOrderRequest(nullptr) {}
  ~queryOrderRequest() override;
  explicit PROTOBUF_CONSTEXPR queryOrderRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  queryOrderRequest(const queryOrderRequest& from);
  queryOrderRequest(queryOrderRequest&& from) noexcept
    : queryOrderRequest() {
    *this = ::std::move(from);
  }
  ...
  inline queryOrderRequest& operator=(queryOrderRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static inline const queryOrderRequest* internal_default_instance() {
    return reinterpret_cast<const queryOrderRequest*>(
               &_queryOrderRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(queryOrderRequest& a, queryOrderRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(queryOrderRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(queryOrderRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  queryOrderRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<queryOrderRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const queryOrderRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const queryOrderRequest& from) {
    queryOrderRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit queryOrderRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:queryOrderRequest)
 private:
  class _Internal;
...
class queryOrderResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:queryOrderResponse) */ {
 public:
  inline queryOrderResponse() : queryOrderResponse(nullptr) {}
  ~queryOrderResponse() override;
  explicit PROTOBUF_CONSTEXPR queryOrderResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  queryOrderResponse(const queryOrderResponse& from);
  queryOrderResponse(queryOrderResponse&& from) noexcept
    : queryOrderResponse() {
    *this = ::std::move(from);
  }
  ...
  inline queryOrderResponse& operator=(queryOrderResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static inline const queryOrderResponse* internal_default_instance() {
    return reinterpret_cast<const queryOrderResponse*>(
               &_queryOrderResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(queryOrderResponse& a, queryOrderResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(queryOrderResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(queryOrderResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  queryOrderResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<queryOrderResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const queryOrderResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const queryOrderResponse& from) {
    queryOrderResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  protected:
  explicit queryOrderResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:queryOrderResponse)
 private:
  class _Internal;
...
class OrderService : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void query_order(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class OrderService_Stub : public OrderService {
 public:
  ...
  void make_order(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       ...
                       ::makeOrderResponse* response,
                       ::google::protobuf::Closure* done);
  void query_order(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::queryOrderRequest* request,
                       ::queryOrderResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
inline const std::string& queryOrderRequest::order_id() const {
  // @@protoc_insertion_point(field_get:queryOrderRequest.order_id)
  return _internal_order_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void queryOrderRequest::set_order_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.order_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:queryOrderRequest.order_id)
}
inline std::string* queryOrderRequest::mutable_order_id() {
  std::string* _s = _internal_mutable_order_id();
  // @@protoc_insertion_point(field_mutable:queryOrderRequest.order_id)
  return _s;
}
inline const std::string& queryOrderRequest::_internal_order_id() const {
  return _impl_.order_id_.Get();
}
inline void queryOrderRequest::_internal_set_order_id(const std::string& value) {
  
  _impl_.order_id_.Set(value, GetArenaForAllocation());
}
inline std::string* queryOrderRequest::_internal_mutable_order_id() {
  
  return _impl_.order_id_.Mutable(GetArenaForAllocation());
}
inline std::string* queryOrderRequest::release_order_id() {
  // @@protoc_insertion_point(field_release:queryOrderRequest.order_id)
  return _impl_.order_id_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:queryOrderRequest.order_id)
}
...
// int32 ret_code = 1;
inline void queryOrderResponse::clear_ret_code() {
  _impl_.ret_code_ = 0;
}
inline int32_t queryOrderResponse::_internal_ret_code() const {
  return _impl_.ret_code_;
}
inline int32_t queryOrderResponse::ret_code() const {
  // @@protoc_insertion_point(field_get:queryOrderResponse.ret_code)
  return _internal_ret_code();
}
inline void queryOrderResponse::_internal_set_ret_code(int32_t value) {
  
  _impl_.ret_code_ = value;
}
inline void queryOrderResponse::set_ret_code(int32_t value) {
  _internal_set_ret_code(value);
  // @@protoc_insertion_point(field_set:queryOrderResponse.ret_code)
}

// string res_info = 2;
inline void queryOrderResponse::clear_res_info() {
  _impl_.res_info_.ClearToEmpty();
}
inline const std::string& queryOrderResponse::res_info() const {
  // @@protoc_insertion_point(field_get:queryOrderResponse.res_info)
  return _internal_res_info();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void queryOrderResponse::set_res_info(ArgT0&& arg0, ArgT... args) {
 
 _impl_.res_info_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:queryOrderResponse.res_info)
}
inline std::string* queryOrderResponse::mutable_res_info() {
  std::string* _s = _internal_mutable_res_info();
  // @@protoc_insertion_point(field_mutable:queryOrderResponse.res_info)
  return _s;
}
inline const std::string& queryOrderResponse::_internal_res_info() const {
  return _impl_.res_info_.Get();
}
inline void queryOrderResponse::_internal_set_res_info(const std::string& value) {
  
  _impl_.res_info_.Set(value, GetArenaForAllocation());
}
inline std::string* queryOrderResponse::_internal_mutable_res_info() {
  
  return _impl_.res_info_.Mutable(GetArenaForAllocation());
}
inline std::string* queryOrderResponse::release_res_info() {
  // @@protoc_insertion_point(field_release:queryOrderResponse.res_info)
  return _impl_.res_info_.Release();
}
inline void queryOrderResponse::set_allocated_res_info(std::string* res_info) {
  if (res_info != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:queryOrderResponse.res_info)
}

// string order_id = 3;
inline void queryOrderResponse::clear_order_id() {
  _impl_.order_id_.ClearToEmpty();
}
inline const std::string& queryOrderResponse::order_id() const {
  // @@protoc_insertion_point(field_get:queryOrderResponse.order_id)
  return _internal_order_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void queryOrderResponse::set_order_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.order_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:queryOrderResponse.order_id)
}
inline std::string* queryOrderResponse::mutable_order_id() {
  std::string* _s = _internal_mutable_order_id();
  // @@protoc_insertion_point(field_mutable:queryOrderResponse.order_id)
  return _s;
}
inline const std::string& queryOrderResponse::_internal_order_id() const {
  return _impl_.order_id_.Get();
}
inline void queryOrderResponse::_internal_set_order_id(const std::string& value) {
  
  _impl_.order_id_.Set(value, GetArenaForAllocation());
}
inline std::string* queryOrderResponse::_internal_mutable_order_id() {
  
  return _impl_.order_id_.Mutable(GetArenaForAllocation());
}
inline std::string* queryOrderResponse::release_order_id() {
  // @@protoc_insertion_point(field_release:queryOrderResponse.order_id)
  return _impl_.order_id_.Release();
}
inline void queryOrderResponse::set_allocated_order_id(std::string* order_id) {
  if (order_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:queryOrderResponse.order_id)
}

// int32 price = 4;
inline void queryOrderResponse::clear_price() {
  _impl_.price_ = 0;
}
inline int32_t queryOrderResponse::_internal_price() const {
  return _impl_.price_;
}
inline int32_t queryOrderResponse::price() const {
  // @@protoc_insertion_point(field_get:queryOrderResponse.price)
  return _internal_price();
}
inline void queryOrderResponse::_internal_set_price(int32_t value) {
  
  _impl_.price_ = value;
}
inline void queryOrderResponse::set_price(int32_t value) {
  _internal_set_price(value);
  // @@protoc_insertion_point(field_set:queryOrderResponse.price)
}

// string goods = 5;
inline void queryOrderResponse::clear_goods() {
  _impl_.goods_.ClearToEmpty();
}
inline const std::string& queryOrderResponse::goods() const {
  // @@protoc_insertion_point(field_get:queryOrderResponse.goods)
  return _internal_goods();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void queryOrderResponse::set_goods(ArgT0&& arg0, ArgT... args) {
 
 _impl_.goods_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:queryOrderResponse.goods)
}
inline std::string* queryOrderResponse::mutable_goods() {
  std::string* _s = _internal_mutable_goods();
  // @@protoc_insertion_point(field_mutable:queryOrderResponse.goods)
  return _s;
}
inline const std::string& queryOrderResponse::_internal_goods() const {
  return _impl_.goods_.Get();
}
inline void queryOrderResponse::_internal_set_goods(const std::string& value) {
  
  _impl_.goods_.Set(value, GetArenaForAllocation());
}
inline std::string* queryOrderResponse::_internal_mutable_goods() {
  
  return _impl_.goods_.Mutable(GetArenaForAllocation());
}
inline std::string* queryOrderResponse::release_goods() {
  // @@protoc_insertion_point(field_release:queryOrderResponse.goods)
  return _impl_.goods_.Release();
}
inline void queryOrderResponse::set_allocated_goods(std::string* goods) {
  if (goods != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:queryOrderResponse.goods)
}
